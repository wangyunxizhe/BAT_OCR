...
public class MySign {
    ...
    public static void main(String[] args) throws Exception {
        long appId = 1259069018;
        String secretId = "AKIDLWl8OOhoSv8AycwPmqfGb3LitpCJq9pW";
        String secretKey = "iDW9WhdJo33mYeYLxLTjqj7IEyQlumQp";
        String rs = appSign(appId, secretId, secretKey, null, 0);
